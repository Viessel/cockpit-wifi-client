...
```
git clone https://github.com/cockpit-project/wifi-client.git
cd wifi-client
make
```
...
ln -s `pwd`/dist ~/.local/share/cockpit/wifi-client
```
...
remove manually the symlink:
    ...
    rm ~/.local/share/cockpit/wifi-client
...
your project after forking from wifi-client.
...
which is run weekly or upon [manual request](https://github.com/cockpit-project/wifi-client/actions) through the
[npm-update.yml](.github/workflows/npm-update.yml) [GitHub action](https://github.com/features/actions).

# Further reading

 * The [Starter Kit announcement](https://cockpit-project.org/blog/cockpit-wifi-client.html)
